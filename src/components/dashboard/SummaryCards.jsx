    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <span className="text-sm font-medium text-white dark:text-gray-400">Total Balance</span>
        ...
        <div className="flex items-center gap-1 mt-2">
          <ArrowUpRight size={14} className="text-white dark:text-emerald-500" />
          <span className="text-xs font-semibold text-white dark:text-emerald-500">+12.5%</span>
          <span className="text-xs text-white/80 dark:text-gray-400">vs last month</span>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <span className="text-sm font-medium text-white dark:text-gray-400">Total Income</span>
        ...
        <div className="flex items-center gap-1 mt-2">
          <ArrowUpRight size={14} className="text-white dark:text-emerald-500" />
          <span className="text-xs font-semibold text-white dark:text-emerald-500">+8.2%</span>
          <span className="text-xs text-white/80 dark:text-gray-400">vs last month</span>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <span className="text-sm font-medium text-white dark:text-gray-400">Total Expenses</span>
        ...
        <div className="flex items-center gap-1 mt-2">
          ...
          <span className="text-xs font-semibold text-white dark:text-rose-500">-3.1%</span>
          <span className="text-xs text-white/80 dark:text-gray-400">vs last month</span>
        </div>
      </motion.div>
    </div>
